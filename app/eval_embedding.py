...
def are_same_nodes(
    ...
    assert isinstance(other_node.embedding, torch.Tensor)
    return (
...
def main():
    ...
    parser.add_argument("-t", "--match-threshold", type=float, default=2.2)
    ...
    all_cluster_ids = get_clusters(gt=gt, scan_id=1)
